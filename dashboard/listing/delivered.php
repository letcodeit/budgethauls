              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><span class="badges bg-lightgreen"><i class="fa fa-thumbs-up m-1"></i>Delivered</span></a></td>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table  datanew">
              ...
              <tbody>
                <?php
                $query = $parcel->get('sender_id = ' . $id . ' AND status = 5');
                if ($query) {
                  while ($row = $query->fetch_assoc()) {
                ?>
                    <tr>
