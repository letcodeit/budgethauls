  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>Booked Listings</h4>
        <h6>Listings Booked for Pick-up</h6>
      </div>
      <!-- <div class="page-btn">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><span class="badges bg-info"><i class="fa fa-bookmark m-1"></i>Booked</span></a></td>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table  datanew">
              ...
              <tbody>
                <?php
                $query = $parcel->get('status = 2 AND assigned_to = ' . $id);
                if ($query) {
                  while ($row = $query->fetch_assoc()) {
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="me-3" id="pickedupBtn" data-value="<?= $row['id'] ?>">
                          <img src="assets/img/icons/pickedup.png" alt="img" />
                        </a> -->
                        <button class="btn btn-outline-info" id="pickedupBtn" data-value="<?= $row['id'] ?>"> Picked-Up</button>
                      </td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['item_name']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['s_address']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['r_address']; ?></a></td>
                      <td>$<a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['budget']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['weight']; ?></a></td>
                      <!-- <td><a href="?parcel=parcel-details&id=<?= $row['id'] ?>"><span class="badges bg-info"><i class="fa fa-bookmark m-1"></i>Booked</span></a></td> -->
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table  datanew">
              ...
              <tbody>
                <?php
                $query = $parcel->get('sender_id =' . $id . ' AND status = 2');
                if ($query) {
                  while ($row = $query->fetch_assoc()) {
                ?>
                    <tr>
...
<script src="./ajax/pickedup.js"></script>