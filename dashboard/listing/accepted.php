  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>Accepted Listings</h4>
        <h6>Accepted by Transporter, Awaiting your approval</h6>
      </div>
      <!-- <div class="page-btn">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['budget']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['weight']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><span class="badges bg-lightpurple"> <i class="fa fa-check-circle m-1"></i>Accepted</span></a></td>
                      <!-- <td>
    ...
    <?php elseif (intval($user['type']) == 3) : ?>
      ...
      <div class="card" id="loader">
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table  datanew" id="tableList">
              <thead>
                <tr>
                  <!-- <th>
                  <label class="checkboxs">
              ...
              <tbody>
                <?php
                $query = $parcel->get('sender_id = ' . $id . ' AND status = 7');
                if ($query) {
                  while ($row = $query->fetch_assoc()) {
                ?>
                    <tr>
                      ...
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['budget']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['weight']; ?></a></td>
                      <td><span class="badges bg-lightpurple"> <i class="fa fa-check-circle m-1"></i>Accepted</span></td>
                      <!-- <td>
                        <a class="me-3" href="?listing=listing-details&id=<?= $row['id'] ?>">
                          <img src="assets/img/icons/eye.svg" alt="img" />
                        </a>

                        <a class="me-3" id="confirmBookBtn" data-value="<?= $row['id'] ?>">
                          <img src="assets/img/icons/accept2.png" alt="img" />
                        </a>
                        <a class="confirm-text" href="javascript:void(0);">
                          <img src="assets/img/icons/delete.svg" alt="img" />
