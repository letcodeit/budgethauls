  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>Picked -Up Listings</h4>
        <h6>Listings Ready for Delivery</h6>
      </div>
      <!-- <div class="page-btn">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><span class="badges bg-primary"><i class="fa fa-hand-holding m-1"></i>Picked-Up</span></a></td>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="me-3" id="transitBtn" data-value="<?= $row['id'] ?>">
                          <img src="assets/img/icons/transit.png" alt="img" />
                        </a> -->

                        <button class="btn btn-outline-success" id="transitBtn" data-value="<?= $row['id'] ?>">Out for Delivery</button>
                      </td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['item_name']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['s_address']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['r_address']; ?></a></td>
                      <td>$<a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['budget']; ?></a></td>
                      <td><a href="?listing=listing-details&id=<?= $row['id'] ?>"><?= $row['weight']; ?></a></td>
                      <!-- <td><span class="badges bg-primary"><i class="fa fa-hand-holding m-1"></i>Picked-Up</span></td> -->
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table  datanew">
              ...
              <tbody>
                <?php
                $query = $parcel->get('sender_id = ' . $id . ' AND status = 3');
                if ($query) {
                  while ($row = $query->fetch_assoc()) {
                ?>
                    <tr>
...
<script src="./ajax/in-transit.js"></script>